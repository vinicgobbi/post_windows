function Install-Jogos {
    Write-Info "Instalando Steam, Heroic (Epic/GOG/Amazon) e Prism Launcher..."
...
Register-Modulo -Id "jogos" -Titulo "Instalar launchers de jogos" `
    -Descricao "Steam, Heroic Games Launcher (Epic Games, GOG e Amazon Games numa cliente só) e Prism Launcher (Minecraft)" `
